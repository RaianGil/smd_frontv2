    ...
    <div className='p-card w-99 mb-2 dbg-1'>
        <div className="row p-2">
            ...
            <div className="col-md-6 fbg-1 ">
                ...
                <label><strong>Bot Buy:</strong> <i>${props.BotBuy}</i></label>
                <label><strong>Bot Limit Buy:</strong> <i>${props.BotLimitBuy}</i></label>
                <label><strong>Bot Sell:</strong> <i>${props.BotSell}</i></label>
                <label><strong>Amount:</strong> <i>${props.BotAmount}</i></label>
